...
class SynthesizerTrn(nn.Module):
  ...
  def forward(self, x, x_lengths, y, y_lengths, sid=None, eid=None):
    ...
    if self.n_emotions > 0:
      e = self.emb_e(eid).unsqueeze(-1) # [b, h, 1] #####
    else:
      e = None
  ...
  def infer(self, x, x_lengths, sid=None, eid=None, noise_scale=1, length_scale=1, noise_scale_w=1., max_len=None):
    x, m_p, logs_p, x_mask = self.enc_p(x, x_lengths)   # Text encoder output
    ...
    if self.n_emotions > 0:
      # print("EMOTIONS:", self.n_emotions)
      e = self.emb_e(eid).unsqueeze(-1) # [b, h, 1]
    else:
      e = None
  ...
  def voice_conversion(self, y, y_lengths, sid_src, sid_tgt):
    ...
    assert self.n_emotions > 0, "n_emotions have to be larger than 0."
